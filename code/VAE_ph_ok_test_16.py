...
imgo = io.imread(r'E:/SEM-publi/data/16/16µs_O-Kα.tif')
...
x1 = tfa.layers.NoisyDense(7, use_bias=True,
                 activation=act,
                 kernel_initializer = init,
                 sigma = sig)(encoder_inputs)
x1 = layers.BatchNormalization()(x1)
x1 = tfa.layers.NoisyDense(64,use_bias=True,
                  activation=act,
                  activity_regularizer=UncorrelatedFeaturesConstraint(64, weightage = 0.5),
...
x1 = tfa.layers.NoisyDense(32,use_bias=True,
                  activation=act,
                  activity_regularizer=UncorrelatedFeaturesConstraint(32, weightage = 0.5),
                  kernel_regularizer=l1l2,
                 sigma = sig)(x1)
x1 = layers.BatchNormalization()(x1)
x1 = tfa.layers.NoisyDense(16,use_bias=True,
                  activation=act,
                  activity_regularizer=UncorrelatedFeaturesConstraint(16, weightage = 0.5),
                  kernel_regularizer=l1l2,
                 sigma = sig)(x1)
x1 = layers.BatchNormalization()(x1)
...
# # x1 = layers.Dense(256, use_bias=False,
# #                  activation=act)(x1)
x1 = tfa.layers.NoisyDense(16,use_bias=False,
                  activation=act,
                  sigma = sig)(x1)
...
class VAE(keras.Model):
    ...
    def train_step(self, data):
        with tf.GradientTape() as tape:
            ...
            total_loss = reconstruction_loss + 0.25*kl_loss
...
z_mean, _, _ = np.array(autoencoder.encoder.predict(img4_re))
rf = z_mean
